<div class="jumbotron">
    ...
    <div class="form-row align-items-center">
        ...
        <div class="col my-auto">
            <input type="range" value="50" min="0" max="100" name="biopsy2" oninput="this.nextElementSibling.value = this.value">
    ...
    <div class="form-row align-items-center">
        ...
        <div class="col my-auto">
            <input type="range" value="50" min="0" style="width:80%; margin-left:10px" name="biopsy3" max="100" step="1" oninput="this.nextElementSibling.value = this.value">
        <output style="margin-left:10px">50</output>%                    
        </div>
        <div class="col my-auto">
    ...
    <div class="form-row align-items-center">
        ...
        <div class="col my-auto">
            <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="biopsy4"style="width:10em">
                <option selected>Choose...</option>
