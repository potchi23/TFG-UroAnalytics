        ...
        <div class="jumbotron">
                ...
                <div class="col-xl-">
                    ...
                    <div class="col my-auto">
                        <select class="custom-select mr-sm-2" name="evolve5" id="inlineFormCustomSelect" style="width:10em">
                            <option selected value="">Choose...</option>
                            <option value="<=18">Bajo riesgo (mayor o igual que 18 meses)</option>
                            <option value="18+">Alto riesgo (menor que 18 meses)</option>
                        </select>
                    </div>
            </div>
            ...
            <div class="form-row align-items-center">
                <div class="col-xl-">
                    ...
                    <div class="col my-auto">
                        <select class="custom-select mr-sm-2" name="evolve6" id="inlineFormCustomSelect" style="width:10em">
                            <option selected value="">Choose...</option>
            ...
            <div class="form-row align-items-center">
                <div class="col-xl-">
                    ...
                    <div class="col my-auto">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value="<" class="custom-control-input" name="evolve7op" id="metop1" onclick="toggleCB(document.getElementById('metop3'))">
                            <label class="custom-control-label" for="metop1">Menor que</label>
                        </div>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value="=" class="custom-control-input" name="evolve7=" id="metop2">
                            <label class="custom-control-label" for="metop2">Igual</label>
                        </div>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value=">" class="custom-control-input" name="evolve7op" id="metop3" onclick="toggleCB(document.getElementById('metop1'))">
            ...
            <div class="form-row align-items-center">
                <div class="col-xl-">
                    ...
                    <div class="col-">
                            <input type="text" class="form-control" name="evolve8" placeholder="meses" style="width:10em;">
                    </div>
                    <div class="col my-auto">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value="<" class="custom-control-input" name="evolve8op" id="segop1" onclick="toggleCB(document.getElementById('segop3'))">
                            <label class="custom-control-label" for="segop1">Menor que</label>
                        </div>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value="=" class="custom-control-input" name="evolve8=" id="segop2">
                            <label class="custom-control-label" for="segop2">Igual</label>
                        </div>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value=">" class="custom-control-input" name="evolve8op" id="segop3" onclick="toggleCB(document.getElementById('segop1'))">
            ...
            <div class="form-row align-items-center">
                <div class="col-xl-">
                    ...
                    <div class="col-">
                            <input type="text" class="form-control" name="evolve9" placeholder="PSAPOS" style="width:10em;">
                    </div>
                    <div class="col my-auto">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value="<" class="custom-control-input" name="evolve9op" id="ultpsaop1" onclick="toggleCB(document.getElementById('ultpsaop3'))">
                            <label class="custom-control-label" for="ultpsaop1">Menor que</label>
                        </div>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value="=" class="custom-control-input" name="evolve9=" id="ultpsaop2">
                            <label class="custom-control-label" for="ultpsaop2">Igual</label>
                        </div>
                        <div class="custom-control custom-switch">
                            <input type="checkbox" value=">" class="custom-control-input" name="evolve9op" id="ultpsaop3" onclick="toggleCB(document.getElementById('ultpsaop1'))">
                ...
                <div class="col-xl-">
                    ...
                    <div class="col my-auto">
                        <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="evolve10" style="width:10em">
                            <option selected value="">Choose...</option>
                            <option value="0-2">Bajo riesgo (0-2)</option>
                            <option value="2-5">Medio (2-5)</option>
                            <option value="5+">Alto riesgo (> 5)</option>
                        </select>
                    </div>
            </div>
        </div>
